  ...
  return (
    ...
    >
      <div className={`relative h-[320px] rounded-3xl border-2 transition-all duration-500 cursor-pointer overflow-hidden bg-gradient-to-b ${colorMap[color]}`}>
        ...
        {/* Bottom Glow */}
        <div className={`absolute bottom-0 left-0 right-0 h-1 transition-all duration-500 opacity-0 group-hover:opacity-100 blur-sm ${color === 'indigo' ? 'bg-indigo-500 shadow-[0_-4px_20px_rgba(99,102,241,0.6)]' :
