...
export default function App() {
  ...
  const handleSaveCard = (card: CardDefinition) => {
    setCollection(prev => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-indigo-500/30">
      ...
      <main className="pl-20 min-h-screen">
        <header className="px-8 py-6 border-b border-slate-900 flex justify-between items-center bg-slate-950/50 backdrop-blur-xl sticky top-0 z-40">
          <div>
